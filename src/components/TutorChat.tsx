    ...
    try {
      ...
      setMessages((m) => [
        ...m,
        {
          id: Date.now() + 1,
          role: "ai",
          text: res.text || "I couldn't generate an answer. Please try again.",
        },
      ]);
    } catch (err) {
      setMessages((m) => [
        ...
        <div className="border-t border-border p-3 sm:p-4">
          <div className="flex flex-wrap gap-2 pb-3">
            <Button
              variant="glass"
              size="sm"
              onClick={() => send(`Give me practice questions on ${subject}`)}
            >
            ...
            <Button
              variant="glass"
              size="sm"
              onClick={() => send(`Build a 2-week ${subject} study plan`)}
            >
