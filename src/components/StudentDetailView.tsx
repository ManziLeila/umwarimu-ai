...
import type { StudentDetail } from "@/lib/backend.server";
    ...
    <div className="space-y-6">
      ...
      {student.subjects.length > 0 && (
        <GlassPanel className="animate-fade-up p-5">
          <SectionLabel>Strengths &amp; gaps</SectionLabel>
          <p className="text-muted-foreground mt-1 text-xs">
            Every subject at a glance — the more the shape pulls inward, the more that subject needs
            support.
          </p>
          <div className="mt-4 h-72">
            <ResponsiveContainer width="100%" height="100%">
              <RadarChart data={student.subjects} margin={{ top: 6, bottom: 6 }}>
